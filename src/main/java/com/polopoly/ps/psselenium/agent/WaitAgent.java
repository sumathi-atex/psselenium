...
public class WaitAgent {
    ...
    public WaitAgent(GUIAgent guiAgent, long defaultTimeoutInSeconds) {
        ...
        try {
            ...
            if (seleniumPolopoly != null) {
                ...
                try {
                    ...
                    WebDriverWait webDriverWait = new WebDriverWait(webDriver, defaultTimeoutInSeconds);
    ...
    public WaitAgent waitForElement(final By locator) {
        ...
        WebDriverWait webDriverWait = new WebDriverWait(guiAgent.getWebDriver(), 
                                                        defaultTimeoutInSeconds);
